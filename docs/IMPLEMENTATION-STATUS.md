...
- Setup wizard, pinned-runtime update command, exact Google artifact URL enforcement, streaming archive hashes, verified Linux x64 binary hash, musl detection, macOS quarantine cleanup, and Windows `taskkill /T` process-tree cleanup.
